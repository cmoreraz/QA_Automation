...
public class AddPostPage {
	...
	public static final Target SELECT_NAME_CAT	= Target.the("Select name categorie").located(By.xpath("//*[@id=\"content\"]/form/div[2]/div/div/div[2]/div[2]/div/select/option[22]"));
