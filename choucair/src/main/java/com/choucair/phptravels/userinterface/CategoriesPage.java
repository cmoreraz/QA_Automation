...
public class CategoriesPage {
	...
	public static final Target LABEL_CAT 	= Target.the("Validate name categorie").located(By.xpath("/html/body/div[3]/div/div[2]/div[2]/div[2]/div/div[1]/div[2]/table/tbody/tr[1]/td[3]"));
